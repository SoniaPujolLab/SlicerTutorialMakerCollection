...
<p>Les images médicales ont traditionnellement été segmentées manuellement, ce qui est un processus fastidieux qui nécessite un effort intensif de la part des radiologues et est sujet à la variabilité inter-observateurs.</p>
...
<p>Support de multiples modalités (CT, IRM).</p><p></p><p></p><p>Anatomies multiples (tête, thorax, abdomen, pelvis, etc.).</p><p></p><p></p><p>Pathologies multiples (tumeur, hémorragie, œdème).</p>
...
# <span style="font-size: 5.5rem; font-weight: 700; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Tâche de segmentation par IA n°1 : Prostate</span>
