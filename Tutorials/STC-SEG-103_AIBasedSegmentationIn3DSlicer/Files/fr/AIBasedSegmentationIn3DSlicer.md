...
<p>Support de multiples modalités (CT, IRM).</p><p></p><p>Anatomies multiples (tête, thorax, abdomen, pelvis, etc.).</p><p></p><p>Pathologies multiples (tumeur, hémorragie, œdème).</p>
