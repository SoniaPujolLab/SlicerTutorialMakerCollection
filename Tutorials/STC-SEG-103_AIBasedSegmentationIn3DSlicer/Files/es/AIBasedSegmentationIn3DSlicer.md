...
<p style="font-size: 2.1rem; line-height: 1.8; font-weight: 300; opacity: 0.9; max-width: 700px; margin: 0 auto;">Segmentación basada en IA en 3D Slicer</p>
...
<p>Clic en Agregar datos en el módulo Bienvenido a 	Slicer</p>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Slicer carga el conjunto de datos de resonancia magnética de próstata</span>
...
<p>Seleccione el modelo Próstata – Multisecuencia</p>
...
<p>Clic en Crear nueva segmentación en</p><p>Aplicar</p>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Slicer inicia la inferencia</span>
...
# <span style="font-size: 5.5rem; font-weight: 700; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Slicer muestra el resultado de la segmentación prostática basada en AI</span>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Cargar dataset4_BrainMRI_Glioma</span>
...
# <span style="font-size: 5.5rem; font-weight: 700; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Slicer inicia la inferencia</span>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Slicer exhibe los resultados de la segmentación basada en IA
usando la Segmentación de Cuerpo Completo TS1- rápida</span>
