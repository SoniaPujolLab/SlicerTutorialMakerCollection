...
<p style="font-size: 2.1rem; line-height: 1.8; font-weight: 300; opacity: 0.9; max-width: 700px; margin: 0 auto;">Segmentação baseada em IA no 3D Slicer</p>
...
<p>Clique em Adicionar Dados no módulo Bem-vindo ao Slicer</p>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Slicer carrega o conjunto de dados de RM da próstata</span>
...
<p>Selecione o modelo Próstata - Multisequência</p>
...
<p>Selecione Criar novo segmento ao</p><p>Aplicar</p>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">O Slicer inicia a inferência</span>
...
# <span style="font-size: 5.5rem; font-weight: 700; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">O Slicer exibe o resultado da segmentação da próstata baseada em IA</span>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Carregar dataset4_BrainMRI_Glioma</span>
...
# <span style="font-size: 5.5rem; font-weight: 700; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">O Slicer inicia a inferência</span>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">O Slicer exibe o resultado da segmentação baseada em IA
usando a Segmentação Corporal Completa TS1 - rápida</span>
