...
<p>Натисніть кнопку «Додати дані» у вікні привітання 	Модуль Slicer</p>
...
<p>Виберіть модель Простата - Мультисеквенція</p>
...
<p>Натисніть кнопку «Створити нову сегментацію» на сторінці</p><p>«Застосувати»</p>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Slicer починає висновок</span>
...
# <span style="font-size: 5.5rem; font-weight: 700; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Slicer показує результат сегментації простати на основі штучного інтелекту</span>
...
# <span style="font-size: 5.5rem; font-weight: 700; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Slicer починає висновок</span>
