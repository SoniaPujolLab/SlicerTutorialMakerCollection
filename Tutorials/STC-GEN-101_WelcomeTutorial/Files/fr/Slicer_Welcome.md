...
# <span style="font-size: 5.5rem; font-weight: 700; margin-bottom: 30px; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Bienvenue dans Slicer</span>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">L’onglet Documentation & Tutoriels 
contient des liens vers 
le compendium de formation et les pages de documentation de la version 4.8 de 3D Slicer.	</span>
...
![Bienvenue dans Slicer](6_WelcometoSlicer.png)
...
![Interface utilisateur de Slicer](7_SlicerUserInterface.png)
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Jeu de données d’exemple IRM du cerveau</span>

<div style="text-align: center; margin: 30px 0; background: #fafafa; padding: 20px; border-radius: 4px;">

![Jeu de données d’exemple IRM du cerveau](14_MRBrainSampleDataset.png)
...
![Jeu de données d’exemple IRM du cerveau](15_MRBrainSampleDataset.png)
...
![Jeu de données d’exemple IRM du cerveau](16_MRBrainSampleDataset.png)
