...
# <span style="font-size: 5.5rem; font-weight: 700; margin-bottom: 30px; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Bem-vindo ao Slicer</span>
...
# <span style="font-size: 5.5rem; font-weight: 700; margin-bottom: 30px; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); display: block;">Slicer Welcome</span>
...
<p>Este tutorial é uma breve introdução ao módulo de boas-vindas do software de código aberto Slicer.</p>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Básico do Slicer5</span>
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Plataformas Suportadas</span>

<div style="font-size: 2rem; line-height: 1.8; color: #444; text-align: justify;">

<p>*O Slicer é um software multiplataforma desenvolvido e mantido para Mac OSX, Linux e Windows.</p><p>*O Slicer requer, no mínimo, 2 GB de RAM e uma placa de vídeo dedicada com 64 MB de memória gráfica integrada. </p>
...
![Bem-vindo ao Slicer](6_WelcometoSlicer.png)
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Interface do Usuário no Slicer</span>

<div style="text-align: center; margin: 30px 0; background: #fafafa; padding: 20px; border-radius: 4px;">

![Interface do Usuário no Slicer](7_SlicerUserInterface.png)
...
![Welcome Module](8_WelcomeModule.png)
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Dados de Exemplo</span>

<div style="text-align: center; margin: 30px 0; background: #fafafa; padding: 20px; border-radius: 4px;">

![Dados de Exemplo](12_SampleData.png)
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Modulo de Boas-vindas</span>

<div style="text-align: center; margin: 30px 0; background: #fafafa; padding: 20px; border-radius: 4px;">

![Modulo de Boas-vindas](13_WelcomeModule.png)
...
![MR Brain Sample Dataset](14_MRBrainSampleDataset.png)
...
![MR Brain Sample Dataset](15_MRBrainSampleDataset.png)
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">RM Cerebral conjunto de dados de exemplo</span>

<div style="text-align: center; margin: 30px 0; background: #fafafa; padding: 20px; border-radius: 4px;">

![RM Cerebral conjunto de dados de exemplo](16_MRBrainSampleDataset.png)
...
## <span style="color: #003366; font-size: 3.5rem; font-weight: 600; display: block; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid #003366;">Indo Além</span>
...
<p>Aliança Nacional para Computação de</p><p>Imagens Médicas</p><p>NIH U54EB005149</p><p></p><p>Centro de Análise de Neuroimagens</p><p>NIH P41EB015902 </p><p></p><p>Iniciativa Chan Zuckerberg (CZI)</p>
